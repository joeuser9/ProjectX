...
Home / Database / Oracle Secure Enterprise Search Documentation, 11g Release 1 (11.1.2)
Secure Enterprise Search Administration API Guide
...
openAdministration Object Types
opensearchadmin Commands
openWeb Service Operations
openJava Example
openError Messages
FeedbackDownload
...
Export web1 to show the full definition.

Create a source group named Web containing web1.

Create and start a schedule named schedule1 for web1.

Print the status of schedule1 after 30 seconds.
